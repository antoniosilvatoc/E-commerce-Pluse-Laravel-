      ...
      <form method="post" action="{{ route('product.update',$product->product_id) }}" enctype="multipart/form-data"
         ...
         <div class="col-xs-12">
            <div class="form-group col-xs-3">
               <label class="control-label no-padding-right" for="product_name"> Nome do produto </label>
            ...
            <div class="form-group col-xs-3">
               <label class="control-label no-padding-right" for="made_in"> Fornecedor </label>
               <input placeholder="Made IN" name="made_in" value="{{ old('made_in',$product->made_in) }}" id="made_in"
                      class="form-control" type="text">
            </div>
            <div class="form-group col-xs-3">
               <label for="brand_id">Escolha as marcas</label>
            ...
            <div class="form-group  col-xs-3">
               <label class=" control-label no-padding-right" for="product_slug"> Url do produto </label>
               <input placeholder="Url do produto" id="product_slug" name="product_slug"
         ...
         <div class="form-group col-xs-12">
            ...
            <div class="col-xs-3">
               ...
               <input placeholder="Quantidade" type="number" value="{{ old("quantity",$product->quantity) }}" min="0"
         ...
         <div class="form-group col-xs-6">
            ...
            <div class="col-sm-8">
               <div class="available0">
                  <label for="data_available"><b>Data da Avaliação</b></label>
         ...
         <div class="form-group col-xs-6">
            <div class="form-group">
               ...
               <div class="col-sm-9">
                  <div class="inline">
                     <input type="text" name="tags" id="form-field-tags" placeholder="Entre com as tags ..."
                            value="<?php foreach ($product->tags as $tag) {
                                echo $tag->tag_name . ',';
                            } ?>"/>
                     <span class="help-button" title="Digite sua tag e pressione Enter">?</span>
                  </div>
                  <label>
                     <h4>Qual o tamanho ? </h4>
         ...
         <div class="col-xs-12">
            ...
            <div class="col-xs-6">
               <div class="widget-box">
                  <div class="widget-header">
                     <h4 class="widget-title">Cor do produto</h4>
                     <div class="widget-toolbar">
                        <a href="#" data-action="collapse">
                           <i class="ace-icon fa fa-chevron-up"></i>
                        </a>
         ...
         <div class="col-xs-12">
            <div class="col-xs-6">
               <input type="submit" class="btn btn-success btn-block" id="submit" value="Salvar">
            </div>
            <div class="col-xs-6">
...
@section('extra_js')
   <script type="text/javascript">
       ...
       jQuery(document).one('load', function (e) {
           jQuery("#site_map").append("<i class='ace-icon fa '></i><a href='{{ route('product.create') }}' class='click_me'>Cadastrar Produto</a>");
               ...
               return function findMatches(q, cb) {
                   ...
                   jQuery.each(strs, function (i, str) {
                       if (substrRegex.test(str)) {
                           // o plugin jQuery typeahead espera sugestões para um
                           // objeto JavaScript, consulte a documentação do tipo antecipado para obter mais informações
