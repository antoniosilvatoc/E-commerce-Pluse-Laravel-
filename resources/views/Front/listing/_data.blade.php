@php
   //VARIÁVEL PARA LEVAR OS PRODUTOS NA ÚLTIMA SEMANA PARA EXIBIR - NOVA ETIQUETA
         ...
         <div class="product_inside">
            <div class="image-box">
               <a href="{{ route('front.show',$product->product_slug) }}" class="load_page">
                  ...
                  @if($product->is_off == 1)
                     <div class="label-sale ">Promoção<br>{{ $product->off }}% de Desconto</div>
                  @endif
                  @if($product->created_at > $data)
                     <div class="label-new">Novo</div>
                  @endif
                  @if($product->status != 1)
                     <div class="label-sale">Em breve!</div>
                  @endif
               </a>
            </div>
            <h2 class="title">
   ...
   <center>
      <div class="offset-80">
         <div class="on-duty-box">
            ...
            <h1 class="block-title large">Categoria vazia</h1>
            <div class="description">
